...
/* To suppress the warning message.
   Samsung Electronics. 2012-06-11 [ */
...
#define ESL_DEF { ESL_UUUU, ESL_UUUU, ESL_UUUU, ESL_UUUU, ESL_UUUU }
/* ] */
...
static const struct TagEntry {
	...
	{EXIF_TAG_NEW_SUBFILE_TYPE, "NewSubfileType",
	 N_("New Subfile Type"), N_("A general indication of the kind of data "
	    "contained in this subfile."), ESL_DEF},
    ...
    /* To suppress the warning message.
       Samsung Electronics. 2012-06-11 */
	{EXIF_TAG_FILL_ORDER, "FillOrder", N_("Fill Order"), "", ESL_DEF},
	/* Not in EXIF 2.2 */
    /* To suppress the warning message.
       Samsung Electronics. 2012-06-11 */
	{EXIF_TAG_DOCUMENT_NAME, "DocumentName", N_("Document Name"), "", ESL_DEF},
	...
	{EXIF_TAG_SUB_IFDS, "SubIFDs", "SubIFD Offsets", N_("Defined by Adobe Corporation "
	    "to enable TIFF Trees within a TIFF file."), ESL_DEF},
	/* Not in EXIF 2.2 */
    /* To suppress the warning message.
       Samsung Electronics. 2012-06-11 */
	{EXIF_TAG_TRANSFER_RANGE, "TransferRange", N_("Transfer Range"), "", ESL_DEF},
	/* Not in EXIF 2.2 */
    /* To suppress the warning message.
       Samsung Electronics. 2012-06-11 */
	{EXIF_TAG_JPEG_PROC, "JPEGProc", "JPEGProc", "", ESL_DEF},
	...
	{EXIF_TAG_CFA_PATTERN, "CFAPattern",
	 ...
	 N_("Indicates the color filter array (CFA) geometric pattern of the "
	    ...
	    "It does not apply to all sensing methods."), ESL_DEF},
	/* Not in EXIF 2.2 */
    /* To suppress the warning message.
       Samsung Electronics. 2012-06-11 */
	{EXIF_TAG_BATTERY_LEVEL, "BatteryLevel", N_("Battery Level"), "", ESL_DEF},
    ...
    /* To suppress the warning message.
       Samsung Electronics. 2012-06-11 */
	{EXIF_TAG_IPTC_NAA, "IPTC/NAA", "IPTC/NAA", "", ESL_DEF},
	/* Not in EXIF 2.2 */
    /* To suppress the warning message.
       Samsung Electronics. 2012-06-11 */
	{EXIF_TAG_IMAGE_RESOURCES, "ImageResources", N_("Image Resources Block"), "", ESL_DEF},
	...
	{EXIF_TAG_TIME_ZONE_OFFSET, "TimeZoneOffset", N_("Time Zone Offset"),
	 N_("Encodes time zone of camera clock relative to GMT."), ESL_DEF},
    ...
    /* To suppress the warning message.
       Samsung Electronics. 2012-06-11 */
	{EXIF_TAG_TIFF_EP_STANDARD_ID, "TIFF/EPStandardID", N_("TIFF/EP Standard ID"), "", ESL_DEF},
	...
	{EXIF_TAG_GAMMA, "Gamma", N_("Gamma"),
	 N_("Indicates the value of coefficient gamma."), ESL_DEF},
	/* Not in EXIF 2.2 */
    /* To suppress the warning message.
       Samsung Electronics. 2012-06-11 */
	{EXIF_TAG_PRINT_IMAGE_MATCHING, "PrintImageMatching", N_("PRINT Image Matching"),
	 N_("Related to Epson's PRINT Image Matching technology"), ESL_DEF},
